...
Template.monthlyprofitandloss.onRendered(() => {
    ...
    if (!localStorage.getItem('VS1PNLPeriodReport_dash')) {
        getInvSales(function (data) {
            ...
            vs1chartService.getProfitLossPeriodReportData(prevMonth7, getLoadDate).then((data) => {
                let month_1 = data.tprofitandlossperiodreport[0].DateDesc_1 || prevMonth7Date;
                let month_2 = data.tprofitandlossperiodreport[0].DateDesc_2 || prevMonth6;
                let month_3 = data.tprofitandlossperiodreport[0].DateDesc_3 || prevMonth5;
                let month_4 = data.tprofitandlossperiodreport[0].DateDesc_4 || prevMonth4;
                let month_5 = data.tprofitandlossperiodreport[0].DateDesc_5 || prevMonth3;
                let month_6 = data.tprofitandlossperiodreport[0].DateDesc_6 || prevMonth2;
                let month_7 = data.tprofitandlossperiodreport[0].DateDesc_7 || prevMonth;
                let month_8 = data.tprofitandlossperiodreport[0].DateDesc_8 || currentMonth;
                ...
                for (let l = 0; l < data.tprofitandlossperiodreport.length; l++) {
                    if (data.tprofitandlossperiodreport[l].AccountTypeDesc.replace(/\s/g, '') == 'TotalExpenses') {
                        month_1_loss_exp = data.tprofitandlossperiodreport[l].Amount_1 || 0;
                        month_2_loss_exp = data.tprofitandlossperiodreport[l].Amount_2 || 0;
                        month_3_loss_exp = data.tprofitandlossperiodreport[l].Amount_3 || 0;
                        month_4_loss_exp = data.tprofitandlossperiodreport[l].Amount_4 || 0;
                        month_5_loss_exp = data.tprofitandlossperiodreport[l].Amount_5 || 0;
                        month_6_loss_exp = data.tprofitandlossperiodreport[l].Amount_6 || 0;
                        month_7_loss_exp = data.tprofitandlossperiodreport[l].Amount_7 || 0;
                        month_8_loss_exp = data.tprofitandlossperiodreport[l].Amount_8 || 0;
                    }

                    if (data.tprofitandlossperiodreport[l].AccountTypeDesc.replace(/\s/g, '') == 'TotalCOGS') {
                    ...
                    if (data.tprofitandlossperiodreport[l].AccountTypeDesc.replace(/\s/g, '') == 'TotalIncome') {
