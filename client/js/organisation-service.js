...
export class OrganisationService extends BaseService {
    ...
    saveOrganisationSetting(data) {
     ...
     getCompanyInfo(){
         let options = {
             PropertyList: "PoBox,PoBox2,PoBox3,PoCity,PoState,PoPostcode,PoCountry,abn,CompanyName,TradingName,PhoneNumber,Address,Address2,Address3,Url,Email,Apcano,DvaABN",
         };
