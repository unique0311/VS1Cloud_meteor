...
export class OrganisationService extends BaseService {
    ...
    saveCustomField(data) {
     ...
     getCompanyInfo(){
         let options = {
             PropertyList: "SiteCode,LastName,Firstname,PoBox,PoBox2,PoBox3,PoCity,PoState,PoPostcode,PoCountry,abn,CompanyName,TradingName,PhoneNumber,Address,Address2,Address3,Url,Email,Apcano,DvaABN,AccountNo,BankBranch,BankCode,Bsb,FileReference,TrackEmails,CompanyNumber",
         };
