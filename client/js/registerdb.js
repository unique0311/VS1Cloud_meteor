...
Template.registerdb.onCreated(function(){
...
Template.registerdb.events({
  'submit .addDatabaseForm' : function (event, template) {
   ...
   let lineItemObjForm = {};
   let extraModuleArr = [];
   $('#emEmail').html(userEmail);
   $('#emPassword').html(cloudconfirmpassword);

   if((url.indexOf('?package=') > 0) && (url.indexOf('itemtotal=') > 0)){
     var getuserqty = url.split('&userqty=');
      let currentuserqty = getuserqty[getuserqty.length-1].split('&');

      var getpaymentAmt = url.split('&itemtotal=');
       let currentpaymentAmt = getpaymentAmt[getpaymentAmt.length-1].split('&');

      var getpackagename = url.split('?package=');
      let currentpackagename = getpackagename[getpackagename.length-1].split('&');
      var arrPackage = currentpackagename[0].split(',');
      let extraModuleAdd = '';

      let userQuantity = parseInt(currentuserqty[0]) * 35;
      let userQuantityDisc = userQuantity / 2;

      paymentamount = currentpaymentAmt[0];
      for (let i = 0; i < arrPackage.length; i++) {
        if(arrPackage[i] == 'vs1_simplestart_trial'){
          licencelevel = 1;
          packagePrice = 35;
          discountPrice = 0;
          renewalPrice = 35;
          ...
          discountDesc = "100% - 1 Month";
        }else if(arrPackage[i] == 'vs1_essentials_trial'){
            licencelevel = 2;
            packagePrice = 50;
            discountPrice = 0;
            renewalPrice = 50;
            ...
            discountDesc = "100% - 1 Month";
         }else if(arrPackage[i] == 'vs1_plus_trial'){
            licencelevel = 3;
            packagePrice = 75;
            discountPrice = 0;
            renewalPrice = 75;
            ...
            discountDesc = "100% - 1 Month";
         }else if(arrPackage[i] == 'vs1_simplestart_sub'){
            licencelevel = 1;
            packagePrice = 35;
            discountPrice = 17.50;
            renewalPrice = 35;
         ...
         }else if(arrPackage[i] == 'vs1_essentials_sub'){
            licencelevel = 2;
            packagePrice = 50;
            discountPrice = 25;
            renewalPrice = 50;
            ...
            discountDesc = "50% - 3 Months";
         }else if(arrPackage[i] == 'vs1_plus_sub'){
            licencelevel = 3;
            packagePrice = 75;
            discountPrice = 37.50;
            renewalPrice = 75;
            ...
            discountDesc = "50% - 3 Months";
         }else if(arrPackage[i] == 'vs1_useforeigncurrency_sub'){
            extraModuleAdd = {
         ...
         }else if(arrPackage[i] == 'vs1_pointofsale_sub'){
            extraModuleAdd = {
              "ModuleName":"POS",
              "Price":39,
            ...
            extraModuleArr.push(extraModuleAdd);
         }else if(arrPackage[i] == 'vs1_websiteintegration_sub'){
            extraModuleAdd = {
            ...
            extraModuleArr.push(extraModuleAdd);
         }else if(arrPackage[i] == 'vs1_extrauser_sub'){
            extraModuleAdd = {
              "ModuleName":"Add Extra User",
               "Price":userQuantity,
               "DiscountedPrice":userQuantityDisc,
               "RenewPrice":userQuantity,
  ...
  if(myArrResponse.ProcessLog.Error){
    ...
    //$(".addloginkey").attr("href", 'http://login.vs1cloud.com:3000?emailakey='+userEmail+'&passkey='+cloudpassword+'&secret='+currentURLQuoteID+'');
