    ...
    */
        ...
        if (customername.val() === '') {
            ...
            salesService.saveSalesOrderEx(objDetails).then(function(objDetails) {
                ...
                for (let l = 0; l < lineItemsForm.length; l++) {
                    stringQuery = stringQuery + "product" + l + "=" + lineItemsForm[l].description + "&price" + l + "=" + lineItemsForm[l].unitPrice + "&qty" + l + "=" + lineItemsForm[l].quantity + "&";
                }
    ...
    'click .payNow': function() {
        ...
        if (id_available == true) {
            let templateObject = Template.instance();
            let quoteData = templateObject.salesorderrecord.get();
            let lineItems = [];
            ...
            stringQuery = stringQuery + "tax=" + tax + "&total=" + total + "&customer=" + customer + "&name=" + name + "&surname=" + surname + "&quoteid=" + quoteData.id + "&company=" + company + "&vs1email=" + vs1User + "&customeremail=" + customerEmail + "&type=Sales Order&url=" + window.location.href + "&server=" + erpGet.ERPIPAddress + "&username=" + erpGet.ERPUsername + "&token=" + erpGet.ERPPassword + "&session=" + erpGet.ERPDatabase + "&port=" + erpGet.ERPPort;
