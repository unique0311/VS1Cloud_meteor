...
Template.stschangegrowthphase.onCreated(function(){
    const templateObject = Template.instance();
    templateObject.departlist = new ReactiveVar([]);
});


Template.stschangegrowthphase.onRendered(function() {
...
Template.stschangegrowthphase.events({
});


Template.stschangegrowthphase.helpers({
    listDept: () => {
