...
Template.stsmanicureplants.onCreated(function(){
    const templateObject = Template.instance();
    templateObject.departlist = new ReactiveVar([]);
});


Template.stsmanicureplants.onRendered(function() {
...
Template.stsmanicureplants.events({
});


Template.stsmanicureplants.helpers({
    listDept: () => {
