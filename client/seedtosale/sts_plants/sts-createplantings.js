...
Template.stscreateplantings.onCreated(function(){
    const templateObject = Template.instance();
    templateObject.departlist = new ReactiveVar([]);
});


Template.stscreateplantings.onRendered(function() {
...
Template.stscreateplantings.events({
});


Template.stscreateplantings.helpers({
    listDept: () => {
