...
//alert(lineQuantity);
  ...
  DangerSound();
   return;
     ...
     htmlAppend = '<tr><td class="form_id"></td><td>' + ''
     + '</td><td>' + '' + '</td>'
     + '<td><input type="text" name="serialNo" id="serialNo" readonly value="'+scannedSerial+'"></td><td>'+ '<a href="#" class="removesecondtablebutton"><i class="fa fa-times" aria-hidden="true"></i></a>' + '</td></tr>';
