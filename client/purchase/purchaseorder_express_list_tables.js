...
Template.purchaseorderlist.events({
    ...
    'keyup #tblpurchaseorderlist_filter input': function (event) {
        ...
        if (dataSearchName.replace(/\s/g, '') != '') {
            sideBarService.getNewPoByNameOrID(dataSearchName).then(function (data) {
               let lineItems = [];
                    let lineItemObj = {};
                    ...
                    if (dataTableList) {
                        ...
                        for (let x = 0; x < item.length; x++) {
                            $("#tblpurchaseorderlist > tbody").append(
                                ...
                                '<td contenteditable="false" class="colSaleDate" ><span style="display:none;">' + item[x].sortdate + '</span>' + item[x].orderdate + '</td>' +
    ...
    'change #dateTo': function() {
        ...
        if (($("#dateFrom").val().replace(/\s/g, '') == "") && ($("#dateFrom").val().replace(/\s/g, '') == "")) {
            ...
            templateObject.getAllFilterPurchaseOrderData(formatDateFrom, formatDateTo, false);
        }
    ...
    'click #lastMonth': function() {
        ...
        templateObject.getAllFilterPurchaseOrderData(getDateFrom, getLoadDate, false);
    },
